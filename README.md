...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 138,596 | 🐛 11 | 🌐 HTML | 📅 2026-09-26 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev

[free-for-dev-zh](https://github.com/qinghuaiorg/free-for-dev-zh) ⭐ 1,694 | 🐛 3 | 📅 2024-04-18 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to Chinese devops and infradev

[awesome](https://github.com/sindresorhus/awesome) ⭐ 510,765 | 🐛 107 | 📅 2026-09-02 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [Gogs](https://github.com/gogits/gogs) ⭐ 47,836 | 🐛 1,013 | 🌐 Go | 📅 2026-09-12  - A painless self-hosted Git Service
* [GitLab](https://github.com/gitlabhq/gitlabhq) ⭐ 24,548 | 🐛 36 | 🌐 Ruby | 📅 2026-09-26 - Version control for your server
* [Package Drone](https://github.com/eclipse/packagedrone) ⚠️ Archived - A package manager repository for OSGi, Java and more

## IDE

* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 192,984 | 🐛 21,152 | 🌐 TypeScript | 📅 2026-09-26 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,254 | 🐛 331 | 🌐 Go | 📅 2026-09-26 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,579 | 🐛 519 | 🌐 Rust | 📅 2026-09-22 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
* [Clipboard](https://github.com/Slackadays/Clipboard) ⭐ 5,912 | 🐛 26 | 🌐 C++ | 📅 2026-05-06 - Cut, copy, and paste anything, anywhere, anytime, all from the terminal.
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,027 | 🐛 1 | 🌐 Java | 📅 2026-09-25 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,590 | 🐛 3,607 | 🌐 Java | 📅 2026-09-26 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,833 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-25 - Free open-source feature flag & toggle service. SDKs for all major languages.

## Security and PKI

* [OpenXPKI](https://github.com/openxpki/openxpki) ⭐ 698 | 🐛 75 | 🌐 Perl | 📅 2026-09-26 - an enterprise-grade PKI/Trustcenter software
...
* [Redmine](https://github.com/redmine/redmine) ⭐ 6,040 | 🐛 3 | 🌐 Ruby | 📅 2026-09-26 - a flexible project management web application written using Ruby on Rails
* [Taiga.io](https://github.com/taigaio) - Your Agile, Free and Open Source Project Management Tool

## PaaS

* [OpenShift](https://github.com/openshift/origin) ⭐ 8,688 | 🐛 326 | 🌐 Go | 📅 2026-09-25 - build, deploy, and manage your applications with Docker and Kubernetes
