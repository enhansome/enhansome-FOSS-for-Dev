...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 132,261 | 🐛 12 | 🌐 HTML | 📅 2026-08-17 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev

[free-for-dev-zh](https://github.com/qinghuaiorg/free-for-dev-zh) ⭐ 1,644 | 🐛 3 | 📅 2024-04-18 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to Chinese devops and infradev

[awesome](https://github.com/sindresorhus/awesome) ⭐ 498,007 | 🐛 105 | 📅 2026-08-18 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [Gogs](https://github.com/gogits/gogs) ⭐ 47,744 | 🐛 1,010 | 🌐 Go | 📅 2026-08-06  - A painless self-hosted Git Service
* [GitLab](https://github.com/gitlabhq/gitlabhq) ⭐ 24,532 | 🐛 37 | 🌐 Ruby | 📅 2026-08-20 - Version control for your server
* [Package Drone](https://github.com/eclipse/packagedrone) ⚠️ Archived - A package manager repository for OSGi, Java and more

## IDE

* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 188,956 | 🐛 19,992 | 🌐 TypeScript | 📅 2026-08-20 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,594 | 🐛 327 | 🌐 Go | 📅 2026-08-17 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,226 | 🐛 422 | 🌐 Rust | 📅 2026-08-11 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,910 | 🐛 0 | 🌐 Java | 📅 2026-08-19 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,475 | 🐛 3,628 | 🌐 Java | 📅 2026-08-20 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,746 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-20 - Free open-source feature flag & toggle service. SDKs for all major languages.
...
* [Redmine](https://github.com/redmine/redmine) ⭐ 6,021 | 🐛 3 | 🌐 Ruby | 📅 2026-08-20 - a flexible project management web application written using Ruby on Rails
* [Taiga.io](https://github.com/taigaio) - Your Agile, Free and Open Source Project Management Tool

## PaaS

* [OpenShift](https://github.com/openshift/origin) ⭐ 8,679 | 🐛 298 | 🌐 Go | 📅 2026-08-20 - build, deploy, and manage your applications with Docker and Kubernetes
