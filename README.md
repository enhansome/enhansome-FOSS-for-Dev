...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 135,344 | 🐛 12 | 🌐 HTML | 📅 2026-08-26 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev

[free-for-dev-zh](https://github.com/qinghuaiorg/free-for-dev-zh) ⭐ 1,666 | 🐛 3 | 📅 2024-04-18 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to Chinese devops and infradev

[awesome](https://github.com/sindresorhus/awesome) ⭐ 500,055 | 🐛 106 | 📅 2026-08-21 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [Gogs](https://github.com/gogits/gogs) ⭐ 47,772 | 🐛 1,008 | 🌐 Go | 📅 2026-08-26  - A painless self-hosted Git Service
* [GitLab](https://github.com/gitlabhq/gitlabhq) ⭐ 24,537 | 🐛 36 | 🌐 Ruby | 📅 2026-08-26 - Version control for your server
* [Package Drone](https://github.com/eclipse/packagedrone) ⚠️ Archived - A package manager repository for OSGi, Java and more

## IDE

* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,617 | 🐛 20,172 | 🌐 TypeScript | 📅 2026-08-26 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,652 | 🐛 326 | 🌐 Go | 📅 2026-08-26 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,263 | 🐛 422 | 🌐 Rust | 📅 2026-08-11 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
...
* [SparkleShare](https://github.com/hbons/SparkleShare) ⭐ 4,979 | 🐛 69 | 🌐 C# | 📅 2026-07-23 - An Open Source collaboration and sharing tool
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,925 | 🐛 0 | 🌐 Java | 📅 2026-08-25 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,499 | 🐛 3,608 | 🌐 Java | 📅 2026-08-25 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,760 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-26 - Free open-source feature flag & toggle service. SDKs for all major languages.
...
* [Mantis](https://github.com/mantisbt/mantisbt) ⭐ 1,796 | 🐛 86 | 🌐 PHP | 📅 2026-08-25 - issue tracker that provides a delicate balance between simplicity and power
...
* [Phabricator](https://github.com/phacility/phabricator) ⭐ 12,298 | 🐛 3 | 🌐 PHP | 📅 2024-04-12 - an open source collection of web applications which help software companies build better software
* [Redmine](https://github.com/redmine/redmine) ⭐ 6,020 | 🐛 3 | 🌐 Ruby | 📅 2026-08-26 - a flexible project management web application written using Ruby on Rails
* [Taiga.io](https://github.com/taigaio) - Your Agile, Free and Open Source Project Management Tool

## PaaS

* [OpenShift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 306 | 🌐 Go | 📅 2026-08-25 - build, deploy, and manage your applications with Docker and Kubernetes
