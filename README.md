...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 135,159 | 🐛 15 | 🌐 HTML | 📅 2026-08-24 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev

[free-for-dev-zh](https://github.com/qinghuaiorg/free-for-dev-zh) ⭐ 1,664 | 🐛 3 | 📅 2024-04-18 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to Chinese devops and infradev

[awesome](https://github.com/sindresorhus/awesome) ⭐ 499,755 | 🐛 106 | 📅 2026-08-21 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [Gogs](https://github.com/gogits/gogs) ⭐ 47,765 | 🐛 1,008 | 🌐 Go | 📅 2026-08-22  - A painless self-hosted Git Service
* [GitLab](https://github.com/gitlabhq/gitlabhq) ⭐ 24,536 | 🐛 37 | 🌐 Ruby | 📅 2026-08-25 - Version control for your server
* [Package Drone](https://github.com/eclipse/packagedrone) ⚠️ Archived - A package manager repository for OSGi, Java and more

## IDE

* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,582 | 🐛 20,116 | 🌐 TypeScript | 📅 2026-08-25 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,645 | 🐛 327 | 🌐 Go | 📅 2026-08-24 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,249 | 🐛 424 | 🌐 Rust | 📅 2026-08-11 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
* [Clipboard](https://github.com/Slackadays/Clipboard) ⭐ 5,888 | 🐛 26 | 🌐 C++ | 📅 2026-05-06 - Cut, copy, and paste anything, anywhere, anytime, all from the terminal.
* [Clifm](https://github.com/leo-arch/clifm) ⭐ 1,722 | 🐛 26 | 🌐 C | 📅 2026-08-22 - The terminal is always in your reach when managing your files.
...
* [SparkleShare](https://github.com/hbons/SparkleShare) ⭐ 4,978 | 🐛 69 | 🌐 C# | 📅 2026-07-23 - An Open Source collaboration and sharing tool
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,921 | 🐛 0 | 🌐 Java | 📅 2026-08-24 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,492 | 🐛 3,606 | 🌐 Java | 📅 2026-08-25 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,753 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-25 - Free open-source feature flag & toggle service. SDKs for all major languages.

## Security and PKI

* [OpenXPKI](https://github.com/openxpki/openxpki) ⭐ 688 | 🐛 73 | 🌐 Perl | 📅 2026-08-11 - an enterprise-grade PKI/Trustcenter software
...
* [Mantis](https://github.com/mantisbt/mantisbt) ⭐ 1,796 | 🐛 85 | 🌐 PHP | 📅 2026-08-25 - issue tracker that provides a delicate balance between simplicity and power
...
* [Redmine](https://github.com/redmine/redmine) ⭐ 6,020 | 🐛 3 | 🌐 Ruby | 📅 2026-08-25 - a flexible project management web application written using Ruby on Rails
* [Taiga.io](https://github.com/taigaio) - Your Agile, Free and Open Source Project Management Tool

## PaaS

* [OpenShift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 306 | 🌐 Go | 📅 2026-08-22 - build, deploy, and manage your applications with Docker and Kubernetes
