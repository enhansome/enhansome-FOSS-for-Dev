...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 135,107 | 🐛 12 | 🌐 HTML | 📅 2026-08-24 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
[awesome](https://github.com/sindresorhus/awesome) ⭐ 499,700 | 🐛 106 | 📅 2026-08-21 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [Gogs](https://github.com/gogits/gogs) ⭐ 47,763 | 🐛 1,008 | 🌐 Go | 📅 2026-08-22  - A painless self-hosted Git Service
...
* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,577 | 🐛 20,090 | 🌐 TypeScript | 📅 2026-08-25 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,640 | 🐛 327 | 🌐 Go | 📅 2026-08-24 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,247 | 🐛 424 | 🌐 Rust | 📅 2026-08-11 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,920 | 🐛 0 | 🌐 Java | 📅 2026-08-24 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,491 | 🐛 3,606 | 🌐 Java | 📅 2026-08-25 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,753 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-24 - Free open-source feature flag & toggle service. SDKs for all major languages.
...
* [Mantis](https://github.com/mantisbt/mantisbt) ⭐ 1,796 | 🐛 85 | 🌐 PHP | 📅 2026-08-24 - issue tracker that provides a delicate balance between simplicity and power
...
* [OpenShift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 307 | 🌐 Go | 📅 2026-08-22 - build, deploy, and manage your applications with Docker and Kubernetes
