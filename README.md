...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 135,755 | 🐛 11 | 🌐 HTML | 📅 2026-08-28 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
[awesome](https://github.com/sindresorhus/awesome) ⭐ 500,829 | 🐛 105 | 📅 2026-08-21 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [GitLab](https://github.com/gitlabhq/gitlabhq) ⭐ 24,546 | 🐛 36 | 🌐 Ruby | 📅 2026-08-28 - Version control for your server
* [Package Drone](https://github.com/eclipse/packagedrone) ⚠️ Archived - A package manager repository for OSGi, Java and more

## IDE

* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,754 | 🐛 20,171 | 🌐 TypeScript | 📅 2026-08-28 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,700 | 🐛 327 | 🌐 Go | 📅 2026-08-26 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,287 | 🐛 424 | 🌐 Rust | 📅 2026-08-11 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
...
* [Clifm](https://github.com/leo-arch/clifm) ⭐ 1,722 | 🐛 26 | 🌐 C | 📅 2026-08-28 - The terminal is always in your reach when managing your files.
...
* [SparkleShare](https://github.com/hbons/SparkleShare) ⭐ 4,980 | 🐛 69 | 🌐 C# | 📅 2026-08-28 - An Open Source collaboration and sharing tool
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,936 | 🐛 1 | 🌐 Java | 📅 2026-08-28 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,512 | 🐛 3,611 | 🌐 Java | 📅 2026-08-27 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,769 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-28 - Free open-source feature flag & toggle service. SDKs for all major languages.
...
* [Mantis](https://github.com/mantisbt/mantisbt) ⭐ 1,797 | 🐛 82 | 🌐 PHP | 📅 2026-08-28 - issue tracker that provides a delicate balance between simplicity and power
* [Bugzilla](https://github.com/bugzilla/bugzilla) ⭐ 852 | 🐛 24 | 🌐 Perl | 📅 2026-08-28 - web-based bug-tracking software
...
* [Redmine](https://github.com/redmine/redmine) ⭐ 6,023 | 🐛 3 | 🌐 Ruby | 📅 2026-08-28 - a flexible project management web application written using Ruby on Rails
* [Taiga.io](https://github.com/taigaio) - Your Agile, Free and Open Source Project Management Tool

## PaaS

* [OpenShift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 314 | 🌐 Go | 📅 2026-08-28 - build, deploy, and manage your applications with Docker and Kubernetes
