...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 132,702 | 🐛 11 | 🌐 HTML | 📅 2026-08-20 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev

[free-for-dev-zh](https://github.com/qinghuaiorg/free-for-dev-zh) ⭐ 1,651 | 🐛 3 | 📅 2024-04-18 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to Chinese devops and infradev

[awesome](https://github.com/sindresorhus/awesome) ⭐ 498,456 | 🐛 105 | 📅 2026-08-18 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [Gogs](https://github.com/gogits/gogs) ⭐ 47,749 | 🐛 1,011 | 🌐 Go | 📅 2026-08-06  - A painless self-hosted Git Service
* [GitLab](https://github.com/gitlabhq/gitlabhq) ⭐ 24,535 | 🐛 37 | 🌐 Ruby | 📅 2026-08-21 - Version control for your server
* [Package Drone](https://github.com/eclipse/packagedrone) ⚠️ Archived - A package manager repository for OSGi, Java and more

## IDE

* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 189,114 | 🐛 20,040 | 🌐 TypeScript | 📅 2026-08-21 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,606 | 🐛 329 | 🌐 Go | 📅 2026-08-21 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,233 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
* [Clipboard](https://github.com/Slackadays/Clipboard) ⭐ 5,877 | 🐛 25 | 🌐 C++ | 📅 2026-05-06 - Cut, copy, and paste anything, anywhere, anytime, all from the terminal.
* [Clifm](https://github.com/leo-arch/clifm) ⭐ 1,719 | 🐛 27 | 🌐 C | 📅 2026-08-21 - The terminal is always in your reach when managing your files.
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 10,913 | 🐛 0 | 🌐 Java | 📅 2026-08-20 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,479 | 🐛 3,619 | 🌐 Java | 📅 2026-08-21 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,747 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-21 - Free open-source feature flag & toggle service. SDKs for all major languages.
...
* [Mantis](https://github.com/mantisbt/mantisbt) ⭐ 1,795 | 🐛 85 | 🌐 PHP | 📅 2026-08-21 - issue tracker that provides a delicate balance between simplicity and power
...
* [Redmine](https://github.com/redmine/redmine) ⭐ 6,022 | 🐛 3 | 🌐 Ruby | 📅 2026-08-21 - a flexible project management web application written using Ruby on Rails
* [Taiga.io](https://github.com/taigaio) - Your Agile, Free and Open Source Project Management Tool

## PaaS

* [OpenShift](https://github.com/openshift/origin) ⭐ 8,680 | 🐛 297 | 🌐 Go | 📅 2026-08-21 - build, deploy, and manage your applications with Docker and Kubernetes
