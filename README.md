...
[free for dev](https://github.com/ripienaar/free-for-dev) ⭐ 137,937 | 🐛 11 | 🌐 HTML | 📅 2026-09-20 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
[awesome](https://github.com/sindresorhus/awesome) ⭐ 508,519 | 🐛 106 | 📅 2026-09-02 - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
...
* [Gogs](https://github.com/gogits/gogs) ⭐ 47,818 | 🐛 1,012 | 🌐 Go | 📅 2026-09-12  - A painless self-hosted Git Service
* [GitLab](https://github.com/gitlabhq/gitlabhq) ⭐ 24,546 | 🐛 36 | 🌐 Ruby | 📅 2026-09-21 - Version control for your server
* [Package Drone](https://github.com/eclipse/packagedrone) ⚠️ Archived - A package manager repository for OSGi, Java and more

## IDE

* [Visual Studio Code](https://github.com/Microsoft/vscode) ⭐ 192,754 | 🐛 21,260 | 🌐 TypeScript | 📅 2026-09-21 - Fully-featured IDE with thousands of extensions, cross-platform app development (Microsoft extensions available for download for iOS and Android), desktop, web and cloud development, multi-language support (C#, C++, JavaScript, Python, PHP and more)
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,170 | 🐛 330 | 🌐 Go | 📅 2026-09-21 - Fuzzy find anything in your directories.
* [Bat](https://github.com/sharkdp/bat) ⭐ 60,527 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - The fancy `cat` with syntax highlighting and effortless fuzzy searching to save development time.
* [Clipboard](https://github.com/Slackadays/Clipboard) ⭐ 5,905 | 🐛 26 | 🌐 C++ | 📅 2026-05-06 - Cut, copy, and paste anything, anywhere, anytime, all from the terminal.
...
* [sonarqube](https://github.com/SonarSource/sonarqube) ⭐ 11,004 | 🐛 0 | 🌐 Java | 📅 2026-09-18 - Put your technical debt under control
* [gerrit](https://gerrit.googlesource.com/) - Code Review
* [Codecov](https://codecov.io/) - Continuous Code Coverage

## CI / CD

* [Jenkins](https://github.com/jenkinsci/jenkins) ⭐ 26,574 | 🐛 3,622 | 🌐 Java | 📅 2026-09-21 - open-source continuous integration server
...
* [Unleash](https://github.com/Unleash/unleash) ⭐ 13,819 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-21 - Free open-source feature flag & toggle service. SDKs for all major languages.
...
* [Mantis](https://github.com/mantisbt/mantisbt) ⭐ 1,805 | 🐛 89 | 🌐 PHP | 📅 2026-09-21 - issue tracker that provides a delicate balance between simplicity and power
...
* [Redmine](https://github.com/redmine/redmine) ⭐ 6,036 | 🐛 3 | 🌐 Ruby | 📅 2026-09-21 - a flexible project management web application written using Ruby on Rails
* [Taiga.io](https://github.com/taigaio) - Your Agile, Free and Open Source Project Management Tool

## PaaS

* [OpenShift](https://github.com/openshift/origin) ⭐ 8,687 | 🐛 322 | 🌐 Go | 📅 2026-09-19 - build, deploy, and manage your applications with Docker and Kubernetes
